...
download.file("https://stats.wikimedia.org/EN/TablesPageViewsMonthlyMobile.htm", "./data/TablesPageViewsMonthlyMobile.htm")
```
```{r}
lang_page <- read_html("https://stats.wikimedia.org/EN/TablesPageViewsMonthlyOriginalCombined.htm")
```
...
names(lang_cols[[1]])<-"code"
names(lang_cols[[2]])<-"name"
bind_cols(lang_cols[[1]],lang_cols[[2]]) %>% 
  mutate(code=tolower(code)) -> language_codes
